...
@EventBusSubscriber(Dist.CLIENT) public class ${name}Overlay {
	...
	<#else>
        ...
        if (<@procedureOBJToConditionCode data.displayCondition/>) {
            <#if data.baseTexture?has_content>
                event.getGuiGraphics().blit(RenderType::guiTextured, BACKGROUND, 0, 0, 0, 0, w, h, w, h);
            </#if>
            ...
            <#list data.getComponentsOfType("Image") as component>
                <#if hasProcedure(component.displayCondition)>
                    ...
                    event.getGuiGraphics().blit(RenderType::guiTextured, IMAGE_${component?index}, <@calculatePosition component/>, 0, 0,
        	...
        	<#list data.getComponentsOfType("Sprite") as component>
				<#if hasProcedure(component.displayCondition)>if (<@procedureOBJToConditionCode component.displayCondition/>) {</#if>
					event.getGuiGraphics().blit(RenderType::guiTextured, SPRITE_${component?index}, <@calculatePosition component/>,
